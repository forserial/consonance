(function () {
  define('consonance', ['consonance.core'], function (core) {
    ...
    function _consonance(a) {
        return consonance.bind(a);
    }

    function consonance(a) {
        if (a !== null) consonance._context = a;
        return stack.length && stack.pop() || consonance;
    }
    consonance.context = getContext;

    function getContext() {
        return context;
    }

    consonance.mic = function mic(cb) {
        if (mic === null) {
            getUserMedia({
                    "audio": {
                        "mandatory": {
